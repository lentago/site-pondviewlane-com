---
title: "Declaration of Trust — Essex Crossing at Montserrat HOA"
description: "Founding Instruments · 2015-12-09"
sidebar:
  order: 5
---

<iframe src="/library/founding/trust-declaration-2015.pdf" title="Declaration of Trust — Essex Crossing at Montserrat HOA" class="doc-viewer" loading="lazy"></iframe>

<a class="doc-download" href="/library/founding/trust-declaration-2015.pdf" target="_blank" rel="noopener">Open PDF in a new tab ↗</a>
...
| **Recording** | Bk 34576 Pg 486 |
| **Pages** | 24 |
| **Size** | 390 KB |

<details>
<summary>Extracted text (searchable)</summary>
<pre class="doc-text">ESSEX CROSSING AT MONTSERRAT HOMEOWNERS ASSOCIATION
...
The Trustees may also act without a meeting by instrument signed by all of their
number.
...
ARTICLE V Beneficiaries and the Beneficial Interest in the Trust
...
Open Space and all improvements thereon, and shall keep the same
...
(n) Enter into contracts for the management and maintenance of the road ways in the
...
executed by the Trustees, or by any agent or employee of the Trustees, shall be
...
addition, or change, and reciting the consent of the Owners herein required to
