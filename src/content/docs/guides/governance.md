...
this page comes from the recorded instruments — the citations open them at
the page.
...
- **Owner quorum is 50% of lots**; owners holding more than half the votes
  can call a special meeting (same page).
...
- **The subdivision's roadways, as the covenant was written** — the 2015 text
  ...
  this clause is the **20-foot emergency access and utility easement** to Ice
  House Lane, which must be kept free of all obstructions (vehicles, snow,
  overgrown brush).
...
pp. 6–7](/library/founding/covenants-easements-2015/#page=6)).
